    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                founded_classes={"bus": 0, "car": 0, "motorcycle": 0, "truck": 0}
                # Print results
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        car_count = result["car"]
        bus_count = result["bus"]
        bike_count = result["motorcycle"]
        truck_count = result["truck"]
